...
$sql = "SELECT usuarios.nombre, usuarios.apellidos, usuarios.email, usuarios.imagen, 
        ...
        ( departamento.nombre = 'FINANCE'
        OR departamento.nombre = 'FINANCE - CONTROLLER')
                              ...
                              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                 ...
                                 <div class="dropdown-submenu">
                                    ...
                                    <div class="dropdown-menu">
                                                    ...
                                                    <a class="dropdown-item active" href="../claimpay/finance">Finance</a>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a class="dropdown-item active" href="../claimpay/finance">Finance</a></li>
