...
$sql = "SELECT usuarios.nombre, usuarios.apellidos, usuarios.email, usuarios.imagen, 
        ...
        departamento.nombre = 'UNDERWRITING'        
                              ...
                              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                 ...
                                 <div class="dropdown-submenu">
                                    ...
                                    <div class="dropdown-menu">
                                                    ...
                                                    <a class="dropdown-item active" href="../claimpay/underwriting">Underwriting</a> 
                                    </div>
                                 </div>
                              </div>
                           </li>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a class="dropdown-item active" href="../claimpay/underwriting">Underwriting</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
