...
$sql = "SELECT usuarios.nombre, usuarios.apellidos, usuarios.email, usuarios.imagen, 
        ...
        AND departamento.nombre = 'SETTLEMENT'
                  ...
                  <nav class="navigation navbar navbar-expand-md navbar-dark">
                     ...
                     <div class="collapse navbar-collapse" id="navbarsExample04">
                        <ul class="navbar-nav mr-auto">
                              ...
                              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                 <div class="dropdown-submenu">
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item active" href="presuit">Presuit</a>
                           ...
                           <li class="nav-item">
                              <a class="nav-link" href="../../assistance/vistas/login.html">Remote assistance</a>
                           </li>
                           <li class="nav-item">
   ...
   <div class="container">
    ...
    <div class="text-left">
        ...
        <p><strong>Funciones:</strong><br> <?php echo nl2br(htmlspecialchars($usuario['tipousuario_descripcion'], ENT_QUOTES, 'UTF-8')); ?></p> 
            ...
            <?php endforeach; ?>
         <?php else: ?>
            <p>No se encontraron usuarios en el área PRESUIT de la empresa ITL.</p>
         <?php endif; ?>
      </div>
   </div>
</section>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6">
                        ...
                        <ul class="link_icon">
                            ...
                            <li class="dropdown-submenu">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item active" href="presuit">Presuit</a></li>
                            ...
                            <li><a href="../../assistance/vistas/login.html" class="dropdown-item">Remote assistance</a></li>
