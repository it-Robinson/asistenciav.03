...
$sql = "SELECT usuarios.nombre, usuarios.apellidos, usuarios.email, usuarios.imagen, 
        ...
        AND departamento.nombre = 'LEGAL ASSISTANT'
                              ...
                              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                 <div class="dropdown-submenu">
                                    ...
                                    <a class="dropdown-item" href="presuit">Settlement</a>
                                                    ...
                                                    <a class="dropdown-item active" href="legalassistant">Legal Assistant</a>
                                ...
                                <ul class="dropdown-menu">
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a class="dropdown-item active" href="legalassistant">Legal Assistance</a></li>
