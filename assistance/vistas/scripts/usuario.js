...
function mostrar(idusuario){
    $.post("../ajax/usuario.php?op=mostrar", {idusuario: idusuario},
        function(data, status){
            ...
            $("#fecha_nacimiento").val(data.fecha_nacimiento); // Asegúrate de que esta línea está presente
            $("#tipo_turno").val(data.tipo_turno); // Añadir esta línea
			$("#empresa").val(data.empresa); // Añadir esta línea
			$("#extension").val(data.extension); // Añadir esta línea
			$("#primary_phone_number").val(data.primary_phone_number); // Añadir esta línea
        });
