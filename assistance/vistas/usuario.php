...
<div class="panel-body table-responsive" id="listadoregistros">
  ...
  <thead>
    <tr>
        ...
        <th style="text-align: center; vertical-align: middle;">Tipo de Turno</th>
        ...
        <th style="text-align: center; vertical-align: middle;">Work Number</th>
...
<div class="panel-body" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
     ...
     <select name="tipo_turno" id="tipo_turno" class="form-control select-picker" required>
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
     ...
     <select name="empresa" id="empresa" class="form-control select-picker" required>
     <option value="" selected hidden>Seleccionar una opción</option>
                <option value="ITL">ITL</option>
                <option value="Claimpay">Claimpay</option>
     </select>
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
  ...
  <input class="form-control" type="date" name="fecha_nacimiento" id="fecha_nacimiento" required>
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" type="text" name="extension" id="extension" maxlength="100" placeholder="Extension" required>
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Primary_phone_number(*):</label>
      
      <input class="form-control" type="text" name="primary_phone_number" id="primary_phone_number" maxlength="100" placeholder="Primary_phone_number" required>
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
