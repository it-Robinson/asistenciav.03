...
document.addEventListener('DOMContentLoaded', function() {
    ...
    submitButton.addEventListener('click', function() {
        ...
        // Guardar en localStorage para bloquear "Entrada de Turno" y "Salida de Turno", junto con la fecha
        localStorage.setItem('entradaTurnoBloqueadaSinBreak', 'true');
...
<?php 
  ...
  <script type="text/javascript" src="scripts/asistenciapar.js"></script>
