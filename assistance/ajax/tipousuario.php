...
switch ($_GET["op"]) {
	...
	if (empty($idtipousuario)) {
		...
		case 'desactivar':
			// Verificar si existen usuarios asociados al tipo de usuario
			if ($tipousuario->tieneUsuariosAsociados($idtipousuario)) {
				echo "No se puede eliminar el tipo de usuario porque está asociado a uno o más usuarios.";
			} else {
